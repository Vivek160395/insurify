...
public class PurchaseInsuranceController {
    ...
    public ResponseEntity<?> returnobjasd(){
        ...
        PolicyDetails policyDetails7=new PolicyDetails(11000,5,500000,1,0,5000000,6700000,45,55);
        PolicyDetails policyDetails8=new PolicyDetails(5000,2,500000,1,0,5000000,960000,45,55);
        PolicyDetails policyDetails9=new PolicyDetails(3000,5,500000,2,2,6000000,900000,30,50);
        PolicyDetails policyDetails10=new PolicyDetails(1000,5,500000,2,2,5000000,1000000,45,55);
        PolicyDetails policyDetails11=new PolicyDetails(5000,6,100000,1,0,780000,1000000,45,55);
        PolicyDetails policyDetails12=new PolicyDetails(3400,7,100000,1,0,6100000,1500000,30,50);
        PolicyDetails policyDetails13=new PolicyDetails(1000,8,100000,1,0,5300000,780000,45,55);
        PolicyDetails policyDetails14=new PolicyDetails(5000,9,100000,1,0,7900000,985000,45,55);
        PolicyDetails policyDetails15=new PolicyDetails(3200,7,100000,2,2,6200000,6500000,30,50);
