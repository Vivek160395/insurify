...
export class RenewalPolicyComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.myModel=0
    this.http.get('http://localhost:8010/api/vk1/policy-id/979714').subscribe((x:any)=>{
     
      
      
    this.http.put<Insurance>("http://localhost:8084/api/testing/11116",x).subscribe((data:any)=> 
    {
